...
Lula, Datena e Kogos encontram itens pessoais em caixas e ocasionalmente em áreas acessíveis. Guardam até dois usos extras, ativados por E sem gastar a recarga normal. Picanha forma um único escudo grande à esquerda e protege de todo dano por quatro segundos; cadeira fica visível na mão e é arremessada pela mira com clique ou E; espada fica equipada por oito segundos e usa golpes de faca em primeira pessoa: clique ou segure para atacar rivais próximos à frente, causando dois corações a cada 0,24 segundo, sem atravessar paredes. O especial original de proteção territorial do Kogos continua disponível quando não há espada coletada.
