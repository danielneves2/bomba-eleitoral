...
export function createPickupFactory({ mesh, box, material, batchStatic, geometries, materials, textures }) {
  const assets=createPixelAssets({geometries,materials,textures});
  const patterns = [
