...
A abertura agora é uma tela de cartucho: logo central, botão Jogar, elenco em primeiro plano e batalha de demonstração real no cenário ao fundo. Bots se movimentam, plantam e arremessam bombas, destroem caixas e a demonstração se renova sem alterar a partida iniciada pelo jogador. Movimento reduzido mantém o fundo estático. A trilha original de menu usa melodia chiptune, baixo e bateria; o áudio começa na primeira interação e respeita silêncio e aba oculta. A seleção vem depois da abertura, com personagem ampliado, cartões claros, azul e amarelo.

No modo 3×3, os dois aliados aparecem no canto superior esquerdo com retrato, nome, três corações e indicação de eliminação, atualizados pelo estado da partida. O Congresso ganhou base envidraçada, torres com faces de concreto, cúpula baixa e uma concha rasa aberta, rampa e gramados. A favela agora possui morros facetados, três camadas de casas, tijolos aparentes, caixas-d’água, varais com camisetas e calças, escadarias e postes. Decoração fora da grade de combate e detalhes repetidos agrupados para renderização.
